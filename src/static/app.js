              ...
              <ul class="participants-list">
                ${details.participants.map(p => `
                  <li>
                    ...
                    <span class="delete-participant" title="Remove participant" data-participant="${p}">&#128465;</span>
                  </li>
                `).join("")}
              </ul>
            </div>
